...
var DomYapici = function DomYapici(product) {
  ...
  cardUlke.textContent = "".concat(product.ülke, " (").concat(product.ülkeKodu, ")");
  cardContainer.append(cardUlke);
  var cardEnBoy = document.createElement('p');
  cardEnBoy.textContent = "Enlem: ".concat(product.enlem, " Boylam: ").concat(product.boylam);
  cardContainer.append(cardEnBoy);
  var cardSehir = document.createElement('p');
  cardSehir.textContent = "\u015Eehir: ".concat(product.bölgeAdı);
  cardContainer.append(cardSehir);
  var cardSaat = document.createElement('p');
  cardSaat.textContent = "Saat dilimi: ".concat(product.saatdilimi);
  cardContainer.append(cardSaat);
  var cardPara = document.createElement('p');
  cardPara.textContent = "Para birimi : ".concat(product.parabirimi);
  cardContainer.append(cardPara);
  var cardIsp = document.createElement('p');
  cardIsp.textContent = "ISP : ".concat(product.isp);
